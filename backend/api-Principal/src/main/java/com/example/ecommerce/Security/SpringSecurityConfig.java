...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests((authz) -> authz
                ...
                .requestMatchers(HttpMethod.PATCH, "/carritos/{idCarrito}/productos/{idProducto}/item_carrito")
                .permitAll()
                .requestMatchers(HttpMethod.DELETE, "/carritos/{idCarrito}/productos/{idproducto}")
                .permitAll()
                .requestMatchers(HttpMethod.POST, "/pedidos/{carritoId}")
                .permitAll()
